...
const Hero = () => {
  ...
  // below is the for the mouse move effect
...
const rotateX = useTransform(ySpring, [0, innerHeight], [10, -50]);
  ...
  return (
    <div id="home" className="h-screen grid place-items-center" onMouseMove={handleMouseMove} onMouseEnter={handleMouseEnter}>
      <div>
        <motion.div initial={{opacity: 0, y: -100}} animate={{opacity:1, y:0}} transition={{delay: .5}} className="flex flex-col items-center justify-center gap-y-3 font-light capitalize sm:p-2">
