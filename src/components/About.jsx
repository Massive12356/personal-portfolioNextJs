...
const About = () => {
  return (
    <div id="about" className ='min-h-screen  flex flex-col items-center justify-center '>
      ...
      <div className='w-[180%]  flex items-center justify-between md:justify-center'>
        <Image
          src={"/about-me.png"}
          alt="About Image"
          width={400}
        ...
        />
        <div className=" relative max-w-[800px] rounded-xl bg-zinc-100 text-justify p-5 dark:bg-zinc-700 transition-colors">
      ...
      <div className='mt-20 w-[170%] flex flex-wrap items-center justify-between gap-x-7 gap-y-10'>
